...
if __name__ == "__main__":
    ...
    input_path = "/home/amr/Documents/Eflesh_STL/Fingertip_thumb/Fingertip1_v4_0.00014586_12.obj_False.obj" #modificar con el path del objeto creado en cut-cell
    output_path = "/home/amr/Documents/Eflesh_STL/Fingertip_thumb/Fingertip1_v4_mesh_0.00014586_12C.obj" #con el path crear el objeto final
    list_of_magnets = [
        [8, 2, [9, -10, -10.5]] # [diameter, thickness, [centerX, centerY, centerZ]]
      #  [9 ,   4, [30, 0, 5]],   # modificar segun magnetos disponibles, mas magnetos requieren mas arrays
    ]
